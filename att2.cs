...
namespace att1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            list = arv.TrasformarEmListaOrdenada();
    ...
    class ArvoreBinaria
    {
        ...
        public List<int> TrasformarEmListaOrdenada()
        {
            List<int> list = new List<int>();
            TrasformarEmListaOrdenada(raiz, ref list);
            return list;    
        }

        public void TrasformarEmListaOrdenada(No i,ref List<int> list)
        {
            ...
            if (i != null)
            {
                TrasformarEmListaOrdenada(i.Esq, ref list);
                list.Add(i.Elemento);
                TrasformarEmListaOrdenada(i.Dir, ref list);
            }
        }
